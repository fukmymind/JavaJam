...
import cc.fukmymind.model.Server;
...
public class newJavaJamServer {
	...
	private void initialize() {
		...
		frmJavaJamServer.setBounds(100, 100, 632, 313);
		...
		panelServer.setBorder(new BevelBorder(BevelBorder.LOWERED, null, null,
				null, null));

		JLabel labelAddress = new JLabel("Address:");

		final JSpinner spinnerPort = new JSpinner();
		spinnerPort.setModel(new SpinnerNumberModel(2013, 2013, 65535, 1));

		JLabel label_1 = new JLabel(":");

		final JFormattedTextField formattedTextFieldAddress = new JFormattedTextField();
		...
		JToggleButton toggleButtonStartStopServer = new JToggleButton(
				"Start server");
		toggleButtonStartStopServer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				String url = formattedTextFieldAddress.getText();
				Server srv = new Server (sock, 1);
				srv.start();
			}
		});
		...
		comboBoxPreferedGenre.setModel(new DefaultComboBoxModel(new String[] {
				"Any", "Rock", "Pop", "Metal", "Blues", "Jazz" }));
		...
		comboBoxPreferedSkill.setModel(new DefaultComboBoxModel(new String[] {
				"Newbie", "Intermediate", "Professional", "Rockstar" }));

		JCheckBox chckbxMakePrivate = new JCheckBox("Make private");
		GroupLayout gl_panelServer = new GroupLayout(panelServer);
		gl_panelServer
				.setHorizontalGroup(gl_panelServer
						...
						.addGroup(
								gl_panelServer
										...
										.addGap(117)));
		gl_panelServer
				.setVerticalGroup(gl_panelServer
						.createParallelGroup(Alignment.LEADING)
						.addGroup(
								gl_panelServer
										.createSequentialGroup()
		...
		gl_panel.setVerticalGroup(gl_panel
				...
				.addComponent(panelServer, GroupLayout.DEFAULT_SIZE, 323,
						Short.MAX_VALUE)
				.addComponent(scrollPane, GroupLayout.DEFAULT_SIZE, 323,
						Short.MAX_VALUE));

		JList listServerLog = new JList();
		listServerLog.setBorder(new BevelBorder(BevelBorder.LOWERED, null,
				null, null, null));
